PL Case Study
This project focuses on analyzing IPL ball-by-ball data using only NumPy.
The goal is to perform efficient data analysis using vectorized operations without using Pandas.
...
Analyze scoring in death overs (16 to 20).
